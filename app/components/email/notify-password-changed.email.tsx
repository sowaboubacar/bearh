...
export function PasswordChangedEmail({ reportUrl, username = "" }: PasswordChangedEmailProps) {
  return (
    <Html>
      <Head>
        <style>
      ...
      <Preview>Votre mot de passe Val d&apos;Oise RH a été modifié</Preview>
      <Tailwind>
          ...
          <Container className="mx-auto py-20">
            <Section className="w-full mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <Section className="px-10 py-12 sm-px-12 sm-py-16 m-4">
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-6">
                  Nous vous informons que le mot de passe de votre compte Val d&apos;Oise RH a été modifié avec succès.
                </Text>
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-6">
                  Si vous n&apos;avez pas modifié votre mot de passe, veuillez prendre immédiatement des mesures pour sécuriser votre compte :
                </Text>
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-6">
                  ...
                  et d&apos;utiliser un mot de passe unique et complexe pour chacun de vos comptes en ligne.
                </Text>
