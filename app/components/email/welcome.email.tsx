...
export function WelcomeEmail({loginUrl, username = "" }: WelcomeEmailProps) {
  return (
    <Html>
      <Head>
        <style>
      ...
      <Preview>Bienvenue sur le portail RH de Val d&apos;Oise</Preview>
      <Tailwind>
            ...
            <Section className="w-full mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <Section className="px-10 py-12 sm-px-12 sm-py-16 m-4">
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-8">
                  Votre compte a été créé avec succès sur le portail RH de Val d&apos;Oise.
                  Nous sommes ravis de vous accueillir dans notre plateforme de gestion RH moderne et intuitive !
                </Text>
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-6 font-medium">
                ...
                <Section className="mb-8">
                  <ul className="list-none p-0 m-0 space-y-4">
                    {[
                      ...
                      <li key={index} className="flex items-center text-[#4a5568] text-lg">
                        <div className="w-3 h-3 rounded-full bg-[#00787d] mr-4 flex-shrink-0" />
                        {feature}
                      </li>
                    ))}
                  </ul>
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-10">
                  Si vous avez des questions, n&apos;hésitez pas à contacter notre équipe RH.
                  Nous sommes là pour vous accompagner dans votre utilisation quotidienne de la plateforme.
                </Text>
