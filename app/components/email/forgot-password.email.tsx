...
export function ResetPasswordEmail({ resetUrl, username = "" }: ResetPasswordEmailProps) {
  return (
    <Html>
      ...
      <Preview>Réinitialisation de votre mot de passe Val d&apos;Oise RH</Preview>
      <Tailwind>
            ...
            <Section className="w-full mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
              ...
              <Section className="px-10 py-12 sm-px-12 sm-py-16 m-4">
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-8">
                  Nous avons reçu une demande de réinitialisation de mot de passe pour votre compte Val d&apos;Oise RH. 
                ...
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-6">
                  Ce lien expirera dans 24 heures pour des raisons de sécurité. Si vous avez besoin d&apos;un nouveau lien, 
                  veuillez refaire une demande de réinitialisation.
                </Text>
                
                <Text className="text-[#4a5568] text-lg leading-relaxed mb-10">
                  Si vous rencontrez des problèmes, n&apos;hésitez pas à contacter notre équipe support.
                </Text>
